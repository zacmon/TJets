...
def OverlayTJetROCS(outputdir1,outputdir2,outputdir3,outputdir4,alg,pt1,pt2,m1,m2,mvatypes,VarsAndRanges):
    ...
    cgr.SaveAs(outputdir4+"Top_"+"FullROCComparison_"+alg+"_BDTAllTjet_pt"+pt1+pt2+".eps")
...
VarsAndRanges["T2jet"] = [0, "100, 0, 0.25", "100, 0, 0.5","L"]
...
VarsAndRanges["T2jet_pt"] = [0, "100, 0, 0.25", "100, 0, 0.18","L"]
VarsAndRanges["T3jet_pt"] = [0, "100, 0, 0.25", "100, 0, 0.08","L"]
VarsAndRanges["T4jet_pt"] = [0, "100, 0, 0.25", "100, 0, 0.06","L"]
VarsAndRanges["T5jet_pt"] = [0, "100, 0, 0.25", "100, 0, 0.04","L"]
VarsAndRanges["v32"] = [0, "100, 0.3, 1.4", "100, 0, 1.05","L"]
VarsAndRanges["v42"] = [0, "100, 0, 0.45", "100, 0, 1.05","L"]
...
VarsAndRanges["pt32"] = [0, "100, 0, 1.5", "100, 0, 1.05","L"]
VarsAndRanges["pt42"] = [0, "100, 0, 1.5", "100, 0, 1.05","L"]
VarsAndRanges["pt52"] = [0, "100, 0, 1.5", "100, 0, 1.05","L"]
...
for alg in algs:
    ...
    for CutRegion in CutRegions:
        ...
        if flag_AllTjet_tmva:
                ...
                tmvacommand +=  " \"" + alg + "_T2jet, " + alg + "_T3jet, " + alg + "_T4jet, " + alg + "_T3jet_Wmass, " + alg + "_T3jet_WmassVolatility, " + alg + "_T2jet_angle, " + alg + "_T3jet_minAngle, " + alg + "_T2jet_pt, " + alg + "_T3jet_pt, " + alg + "_T4jet_pt, " + alg + "_Tau32\" "
                #tmvacommand +=  " \"" + alg + "_T3jet_WmassVolatility, " + alg + "_T2jet, " + alg + "_T3jet, " + alg + "_T2jet_angle, " + alg + "_T3jet_minAngle, " + alg + "_T3jet_Wmass, " + alg + "_T4jet, " + alg + "_T2jet_pt, " + alg + "_T3jet_pt, " + alg + "_T4jet_pt\" "
